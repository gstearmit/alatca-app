...
--
-- Host: localhost
-- Generation Time: Apr 04, 2014 at 05:58 AM
...
(5, '00000000', 'admin', 'admin@yahoo.com', 'e10adc3949ba59abbe56e057f20f883e', 'trung', 'pham', 915037200, 1, 2013, 'vn', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 'friend', 'friend', NULL, 1, 1, 0, 0, NULL),
(21, '00000000', 'hoaphuong', 'abc', 'e10adc3949ba59abbe56e057f20f883e', 'phuơng ', 'hoa', NULL, NULL, NULL, 'vn', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 'friend', 'friend', NULL, 4, 1, 0, 0, NULL),
(22, '00000000', 'tranhuong', 'gjkg', 'e10adc3949ba59abbe56e057f20f883e', 'tran', 'huong', NULL, NULL, NULL, 'vn', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 'friend', 'friend', NULL, 1, 1, 0, 0, NULL),
(23, '00000000', 'hoahong', 'cxv', 'e10adc3949ba59abbe56e057f20f883e', 'df', 'GFGFHGH', NULL, NULL, NULL, 'vn', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 'friend', 'friend', NULL, 5, 1, 0, 0, NULL);
...
(412, 121, 'index', 'Truy cập', 'Elements', 1),
(413, 121, 'navbar', 'navbar', NULL, 1),
(414, 121, 'sibarleft', 'sibarleft', NULL, 1),
(415, 121, 'content', 'content', NULL, 1),
(416, 122, 'index', 'Truy cập', 'Excutes', 1),
(417, 122, 'update', 'Cập nhật', NULL, 1),
(418, 123, 'index', 'Truy cập', 'Identity', 1),
(419, 123, 'update', 'Cập nhật', NULL, 1),
(420, 124, 'index', 'Truy cập', 'Magazinepublishing', 1),
(421, 125, 'index', 'Truy cập', 'Report', 1),
(422, 125, 'view', 'view', NULL, 1),
(423, 125, 'process', 'process', NULL, 1),
(424, 125, 'update', 'Cập nhật', NULL, 1),
(425, 126, 'index', 'Truy cập', 'Useradmin', 1),
(426, 126, 'role', 'role', NULL, 1),
(427, 126, 'editpass', 'editpass', NULL, 1),
(428, 126, 'getpass', 'getpass', NULL, 1),
(429, 126, 'editpassadmin', 'editpassadmin', NULL, 1),
(430, 126, 'update', 'Cập nhật', NULL, 1),
(431, 126, 'check_exitemail', 'check_exitemail', NULL, 1),
(432, 127, 'index', 'Truy cập', 'Widget', 1),
(433, 127, 'widgetjob', 'widgetjob', NULL, 1),
(434, 127, 'widgetdomain', 'widgetdomain', NULL, 1),
(435, 127, 'widgetleadreturn', 'widgetleadreturn', NULL, 1),
(436, 127, 'widgetcampaignresponse', 'widgetcampaignresponse', NULL, 1),
(437, 127, 'denied', 'denied', NULL, 1);
...
(121, 'elements', 'Elements', NULL, 1),
(122, 'excutes', 'Excutes', NULL, 1),
(123, 'identity', 'Identity', NULL, 1),
(124, 'magazinepublishing', 'Magazinepublishing', NULL, 1),
(125, 'report', 'Report', NULL, 1),
(126, 'useradmin', 'Useradmin', NULL, 1),
(127, 'widget', 'Widget', NULL, 1);
